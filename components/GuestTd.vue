<template>
  <tr>
    <td>
      <v-text-field label="Name" v-model="localGuest.name"></v-text-field>
    </td>
    <td>
      <v-text-field label="Gift" v-model="localGuest.gift"></v-text-field>
    </td>
    <td>
      <v-text-field
        label="Confirmed"
        v-model="localGuest.confirmed"
      ></v-text-field>
    </td>
    <td>
...
export default {
  ...
  computed: {
    ifModify() {
      if (
        this.guest.name !== this.localGuest.name ||
        this.guest.gift !== this.localGuest.gift ||
        this.guest.confirmed !== this.localGuest.confirmed
      ) {
        return true;
      } else {
        return false;
